...
vars <- c("N_hat_f","N_hat_rn","Modnames","AICcWt","Estimate","SE", #"N_hat_conf_level",
          "N_hat_LCL", "N_hat_UCL")
...
vars <- c(#"N_hat_f",
          "N_hat_rn","Modnames","AICcWt","Estimate","SE",# "N_hat_conf_level",
          "N_hat_LCL", "N_hat_UCL")
...
vars <- c(#"N_hat_f","N_hat_rn",
          "Modnames","AICcWt","Estimate","SE", #"N_hat_conf_level",
          "N_hat_LCL", "N_hat_UCL")
#vars %in% names(nop.length.class.ma.N_hat_length.class)
temp <- nop.length.class.ma.N_hat_length.class[,vars]
ft <- flextable(temp)
